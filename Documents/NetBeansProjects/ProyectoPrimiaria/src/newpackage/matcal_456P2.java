 ...
 * @author ElianLv
 */
public class matcal_456P2 extends javax.swing.JFrame {
    ...
    String[] Titulos3 = {"ID","Alumno","Español","Matematicas"," SegundaLengua","CienciasNaturales","Geografia","Historia","FormCivica","Artes","EducacionFisica","Promedio"}; // Para llenar las columnas de tabla calificaciones
    ResultSet rs;
    ...
    void limpiar(){
        // Limpiado de Inputs de materias ids y buscadores
        txtEspañol.setText("0");
        txtMatematicas.setText("0");
        txtIngles.setText("0");
        txtFormCivica.setText("0");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Calificaciones Parciales Perido 2");
        ...
        jLabel4.setText("Solo agregar Calificaciones para 4to, 5to y  6to Grado");
        ...
        jLabel13.setText("Form. Civica Etica");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(txtGeografia, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addComponent(jLabel11, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(txtHistoria, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(34, 34, 34)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(txtEducacionFisica, javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(txtArtes, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 72, Short.MAX_VALUE))))
                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        try {
            // Valores Estaticos
            int periodo = 2; // El periodo es esta vista es estatico es 1
            ...
            float valorCaliGeografia = Float.valueOf(txtGeografia.getText());
            float valorCaliHistoria = Float.valueOf(txtHistoria.getText());
            ...
            if(valorCaliEspañol == 0){
                promedio = (valorCaliMatematicas+valorCaliIngles+valorCaliCieNaturales+valorCaliGeografia+valorCaliHistoria+valorCaliFormCivica+valorCaliArtes+valorCaliEduFisica)/8;
            ...
            if(valorCaliMatematicas == 0){
                promedio = (valorCaliEspañol+valorCaliIngles+valorCaliCieNaturales+valorCaliGeografia+valorCaliHistoria+valorCaliFormCivica+valorCaliArtes+valorCaliEduFisica)/8;
                conver = String.valueOf(promedio);
                conver = conver.substring(0,3);
                System.out.println("Valor Sin: " + conver);
                promedio = Float.parseFloat(conver);
            ...
            if(valorCaliIngles == 0){
                promedio = (valorCaliEspañol+valorCaliMatematicas+valorCaliCieNaturales+valorCaliGeografia+valorCaliHistoria+valorCaliFormCivica+valorCaliArtes+valorCaliEduFisica)/8;
                conver = String.valueOf(promedio);
                conver = conver.substring(0,3);
                System.out.println("Valor Sin: " + conver);
                promedio = Float.parseFloat(conver);
            ...
            if(valorCaliCieNaturales == 0){
                promedio = (valorCaliEspañol+valorCaliMatematicas+valorCaliIngles+valorCaliGeografia+valorCaliHistoria+valorCaliFormCivica+valorCaliArtes+valorCaliEduFisica)/8;
                conver = String.valueOf(promedio);
                conver = conver.substring(0,3);
                System.out.println("Valor Sin: " + conver);
                promedio = Float.parseFloat(conver);
            ...
            if(valorCaliGeografia == 0){
                promedio = (valorCaliEspañol+valorCaliMatematicas+valorCaliIngles+valorCaliCieNaturales+valorCaliHistoria+valorCaliFormCivica+valorCaliArtes+valorCaliEduFisica)/8;
                conver = String.valueOf(promedio);
                conver = conver.substring(0,3);
                System.out.println("Valor Sin: " + conver);
                promedio = Float.parseFloat(conver);
            ...
            if(valorCaliHistoria == 0){
                promedio = (valorCaliEspañol+valorCaliMatematicas+valorCaliIngles+valorCaliCieNaturales+valorCaliGeografia+valorCaliFormCivica+valorCaliArtes+valorCaliEduFisica)/8;
                conver = String.valueOf(promedio);
                conver = conver.substring(0,3);
                System.out.println("Valor Sin: " + conver);
                promedio = Float.parseFloat(conver);
            ...
            if(valorCaliFormCivica == 0){
                promedio = (valorCaliEspañol+valorCaliMatematicas+valorCaliIngles+valorCaliCieNaturales+valorCaliGeografia+valorCaliHistoria+valorCaliArtes+valorCaliEduFisica)/8;
                conver = String.valueOf(promedio);
                conver = conver.substring(0,3);
                System.out.println("Valor Sin: " + conver);
                promedio = Float.parseFloat(conver);
            ...
            if(valorCaliArtes == 0){
                promedio = (valorCaliEspañol+valorCaliMatematicas+valorCaliIngles+valorCaliCieNaturales+valorCaliGeografia+valorCaliHistoria+valorCaliFormCivica+valorCaliEduFisica)/8;
                conver = String.valueOf(promedio);
                conver = conver.substring(0,3);
                System.out.println("Valor Sin: " + conver);
                promedio = Float.parseFloat(conver);
            ...
            if(valorCaliEduFisica == 0){
                promedio = (valorCaliEspañol+valorCaliMatematicas+valorCaliIngles+valorCaliCieNaturales+valorCaliGeografia+valorCaliHistoria+valorCaliFormCivica+valorCaliArtes)/8;
                conver = String.valueOf(promedio);
                conver = conver.substring(0,3);
                System.out.println("Valor Sin: " + conver);
                promedio = Float.parseFloat(conver);
            ...
            if(valorCaliEspañol >= 1 && valorCaliMatematicas >= 1 && valorCaliIngles >= 1 && valorCaliCieNaturales >= 1 && valorCaliGeografia >= 1 && valorCaliHistoria >= 1 && valorCaliFormCivica >= 1 && valorCaliArtes >= 1 && valorCaliEduFisica >= 1){
                // Si se llenaron todos los inputs se sacara la calificacion de manera nornal
                promedio = (valorCaliEspañol+valorCaliMatematicas+valorCaliIngles+valorCaliCieNaturales+valorCaliGeografia+valorCaliHistoria+valorCaliFormCivica+valorCaliArtes+valorCaliEduFisica)/9;
                conver = String.valueOf(promedio);
                conver = conver.substring(0,3);
                System.out.println("Valor Sin: " + conver);
                promedio = Float.parseFloat(conver);
            ...
            PreparedStatement pps = (PreparedStatement) cn.prepareStatement("INSERT INTO matcal_456(español,matematicas,segunda_lengua,ciencias_naturales,geografia,historia,form_civica_etica,artes,eduacion_fisica,promedio,periodo,alumno_id)  VALUES("+valorCaliEspañol+","+valorCaliMatematicas+","+valorCaliIngles+","+valorCaliCieNaturales+","+valorCaliGeografia+","+valorCaliHistoria+","+valorCaliFormCivica+","+valorCaliArtes+","+valorCaliEduFisica+","+promedio+","+periodo+","+valor1Alumno+")");
            pps.executeUpdate();
            limpiar();
            JOptionPane.showMessageDialog(null, "Calificaciones Agregadas");
        } catch (SQLException ex) {
            Logger.getLogger(matcal_456P2.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void buscador3KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscador3KeyReleased
       // Codigo para filtrar las materias
        ...
        try {
            java.sql.Statement st_cont = cn.createStatement(); //hacemos lo mismo que con el metodo mostrar, buscamos el numero de filas dela tabla
            ResultSet rs = st_cont.executeQuery("select COUNT(*) from matcal_456 inner join alumno on matcal_456.alumno_id=alumno.id where alumno.nombre like'" + buscador3.getText() + "%'or alumno.grupo_idgrado like'" + buscador3.getText() + "%'and matcal_456.periodo like'" +periodo+"'");
            ...
            M_datos3 = new String[valor][13];
            rs = st_cont.executeQuery("select * from matcal_456 inner join alumno on matcal_456.alumno_id=alumno.id where alumno.nombre like'" + buscador3.getText() + "%'or alumno.grupo_idgrado like'" + buscador3.getText() + "%' and matcal_456.periodo like'" +periodo+"'");
            while (rs.next()) {
                M_datos3[cont][0] = rs.getString("matcal_456.id");
                M_datos3[cont][1] = rs.getString("alumno.nombre");
                M_datos3[cont][2] = rs.getString("matcal_456.español");
                M_datos3[cont][3] = rs.getString("matcal_456.matematicas");
                M_datos3[cont][4] = rs.getString("matcal_456.segunda_lengua");
                M_datos3[cont][5] = rs.getString("matcal_456.ciencias_naturales");
                M_datos3[cont][6] = rs.getString("matcal_456.geografia");
                M_datos3[cont][7] = rs.getString("matcal_456.historia");
                M_datos3[cont][8] = rs.getString("matcal_456.form_civica_etica");
                M_datos3[cont][9] = rs.getString("matcal_456.artes");
                M_datos3[cont][10] = rs.getString("matcal_456.eduacion_fisica");
                M_datos3[cont][11] = rs.getString("matcal_456.promedio");
                cont = cont + 1;
            }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(fila>=0) {
            ...
            txtGeografia.setText(jtable_datos.getValueAt(fila, 6).toString());
            txtHistoria.setText(jtable_datos.getValueAt(fila, 7).toString());
            txtFormCivica.setText(jtable_datos.getValueAt(fila, 8).toString());
            txtArtes.setText(jtable_datos.getValueAt(fila, 9).toString());
            txtEducacionFisica.setText(jtable_datos.getValueAt(fila, 10).toString());
            
            txtPromedio.setText(jtable_datos.getValueAt(fila, 11).toString());
        } else {
            JOptionPane.showMessageDialog(null, "Fila No seleccionada");
        }
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        ...
        if(fila>=0){
            try {
                PreparedStatement pps = (PreparedStatement) cn.prepareStatement("DELETE FROM matcal_456 WHERE id='"+valor+"'");
                pps.executeUpdate();
    ...
    private void actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actualizarActionPerformed
       ...
       if(valorCaliIngles == 0){
        ...
        try {
            pps = (PreparedStatement) cn.prepareStatement("UPDATE matcal_456 SET español='"+txtEspañol.getText()+"',matematicas='"+txtMatematicas.getText()+"',segunda_lengua='"+txtIngles.getText()+"',ciencias_naturales='"+txtCiencias.getText()+"',geografia='"+txtGeografia.getText()+"',historia='"+txtHistoria.getText()+"',form_civica_etica='"+txtFormCivica.getText()+"',artes='"+txtArtes.getText()+"',eduacion_fisica='"+txtEducacionFisica.getText()+"',promedio='"+promedio+"' WHERE id='"+id_alumnocal.getText()+"';");
            pps.execute();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new matcal_456P2().setVisible(true);
            }
        });
    }
