 ...
 * @author ElianLv
 */
public class matcal_456 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Calificaciones Parciales Perido 1");
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        try {
            // Valores Estaticos
            int periodo = 1; // El periodo es esta vista es estatico es 1
            ...
            Logger.getLogger(matcal_456.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new matcal_456().setVisible(true);
            }
        });
    }
