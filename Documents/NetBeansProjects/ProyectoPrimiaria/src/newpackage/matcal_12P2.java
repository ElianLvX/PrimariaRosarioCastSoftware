 ...
 * @author ElianLv
 */
public class matcal_12P2 extends javax.swing.JFrame {
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        try {
            // Valores Estaticos
            int periodo = 2; // El periodo es esta vista es estatico es 2
            ...
            PreparedStatement pps = (PreparedStatement) cn.prepareStatement("INSERT INTO matcal_12(lengua_materna,matematicas,lengua_extrangera,conocimiento_medio,artes,educacion_fisica,promedio,periodo,alumno_id) VALUES(" +valorCaliLenguaMaterna+ "," +valorCaliMatematicas+ "," +
                    valorCaliIngles+","+valorCaliConMedio+","+valorCaliArtes+","+valorCaliEduFisica+","+promedio+","+periodo+","+valor1Alumno+")");
            ...
            Logger.getLogger(matcal_12P2.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new matcal_12P2().setVisible(true);
            }
        });
    }
