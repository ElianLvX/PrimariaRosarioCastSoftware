 ...
 * @author ElianLv
 */
public class matcal_3P2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buscador3.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                buscador3MouseClicked(evt);
            }
        });
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        ...
        try {
            ...
            Logger.getLogger(matcal_3P2.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void buscador3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buscador3MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_buscador3MouseClicked
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new matcal_3P2().setVisible(true);
            }
        });
    }
